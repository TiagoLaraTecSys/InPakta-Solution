...
public class SwaggerConfig {
	...
	public Docket api() {
		return new Docket(DocumentationType.SWAGGER_2)
				...
				.select().apis(RequestHandlerSelectors.basePackage("com.laratecsys.inpaktaService.Resource"))
				.paths(PathSelectors.any()).build().apiInfo(apiInfo());
	}

	private ApiInfo apiInfo() {
		return new ApiInfo("API dos Serviços Web InPakta",
				"Esta API é utilizada tanto para gerenciamento de clientes e para o mapeamento de dados de Banco de dados em conjunto com o ReDatasense3.0",
				"Versão 1.0", "https://www.inpakta.com.br/",
				new Contact("Tiago Ribeiro", "laratecsys@gmail.com", "laratecsys@gmail.com"),
				"Permitido uso para os desenvolvedores", "https://www.inpakta.com.br/", Collections.emptyList() // Vendor
																												// Extensions
		);
	}
